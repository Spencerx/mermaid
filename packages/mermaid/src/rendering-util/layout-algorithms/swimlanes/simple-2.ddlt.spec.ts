...
const FIXTURE_PATH = resolve(
  __dirname,
  '../../../../../../cypress/platform/dev-diagrams/layout-tests/swimlanes/simple-2.sizes.json'
);

const MMD_PATH = resolve(
  __dirname,
  '../../../../../../cypress/platform/dev-diagrams/layout-tests/swimlanes/simple-2.mmd'
);

function loadFixture(): SizesFixture {
  return loadFreshSizesFixture(FIXTURE_PATH, MMD_PATH, 'swimlanes/simple-2');
}
